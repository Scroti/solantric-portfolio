...
export const testimonialType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'quoteRo', title: 'Quote (RO)', type: 'text', rows: 4, validation: (r) => r.max(240) }),
    defineField({ name: 'quoteEn', title: 'Quote (EN)', type: 'text', rows: 4, validation: (r) => r.max(240) }),
