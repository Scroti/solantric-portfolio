...
export const translations = {
  ro: {
    ...
    submit: {
      ...
      sub: 'Câteva cuvinte despre cum a fost colaborarea noastră.',
      name: 'Numele tău',
      role: 'Rol / companie (opțional)',
      quote: 'Testimonialul tău',
      placeholder: 'Scrie câteva cuvinte...',
      send: 'Trimite',
      sending: 'Se trimite...',
      okTitle: 'Mulțumesc!',
      okSub: 'Testimonialul a fost trimis. Va apărea pe site după ce îl verific.',
      error: 'Ceva n-a mers. Încearcă din nou.',
      left: 'caractere rămase',
    },
    contact: {
      label: 'Contact',
      title: 'Să lucrăm\nîmpreună.',
  ...
  en: {
    ...
    submit: {
      ...
      sub: 'A few words about how working together went.',
      name: 'Your name',
      ...
      sending: 'Sending...',
      okTitle: 'Thank you!',
      okSub: 'Your testimonial was submitted. It will appear after I review it.',
